## Project Memory
40 active memory entities · auto-generated L0 index (regenerated by the write hook and `memoryschema reconcile`) — full content in `memory/<name>.md` and the store.
