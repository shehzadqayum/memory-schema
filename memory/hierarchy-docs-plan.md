...
status: archived
relations:
  - DEPENDS_ON package-audit-plan
---

Plan for hierarchy/inheritance reference doc + 7 documentation alignment fixes

## Observations

- 9 items: 1 new reference doc, 1 plan doc move, 7 alignment fixes across 12 files
- New doc: docs/hierarchy-and-inheritance.md — standalone feature guide with examples, API, troubleshooting
- Alignment fixes: doctor Python version, stale counts, phantom memory/user/ path, importance 8-10 vs 10, scoring bonuses
- Cross-references: forward refs from README, system-overview, tech-ref, impl-guide to new doc
...
Migrated from genesis 2026-07-13 (extraction seeding). Removed relations to non-migrated entities: DEPENDS_ON session-5-close.
