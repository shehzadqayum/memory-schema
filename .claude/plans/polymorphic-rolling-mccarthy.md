...
### 1.4 MEMORY.md budget and eviction
...
### 1.5 Consolidation as reflection, not just indexing
...
### 2.1 Decouple importance from scope
...
### 2.2 Implement or remove type semantics
...
### 3.1 Provenance field (schema v3)
...
### 3.2 Trust-weighted retrieval and L0 gating
...
### 3.3 Pre-consolidation write gate
...
### 4.1 Single source of hierarchy
...
### 4.2 Dot-boundary prefix matching
...
### 5.3 Progressive disclosure for L0
