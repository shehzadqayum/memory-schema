...
`memoryschema doctor` is the health check entry point. It runs 18 checks against the live system — Python, package, config, filesystem, Docker, Neo4j, Voyage AI, hook, tests — and reports status with self-documented remediation for any failures.
